...
perl ${liWGS_SV}/scripts/SE_largeCNV/mergeSegments.pl ${ID}.log2.segments.p_value --ref-arm-sizes ${liWGS}/data/h37.chr.arm.bed --output-basename ${ID} --amp-threshold 0.3 --del-threshold -0.3
mv `pwd`/${sampleid}.* ${sampleid}/
